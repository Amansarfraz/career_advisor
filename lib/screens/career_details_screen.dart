...
final Map<String, _CareerData> _careerDatabase = {
  'Software Engineer': _CareerData(
    name: 'Software Engineer',
    icon: Icons.code,
    requiredSkills: 'Java, Python, SQL, DSA, OOP',
    educationPath: 'CS Degree / Bootcamp',
    salaryRange: '\$70,000 - \$120,000+',
    roadmap: [
      {'title': '1. Fundamentals', 'desc': 'Learn programming basics and DSA.'},
      {'title': '2. Projects', 'desc': 'Build real-world projects.'},
      {'title': '3. Specialization', 'desc': 'Pick a domain and grow skills.'},
    ],
  ),
};
  ...
  Widget build(BuildContext context) {
    ...
    if (career == null) {
      return Scaffold(
        ...
        body: const Center(child: Text("Career not found")),
      );
    }
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text("Required Skills: ${career.requiredSkills}"),
                    Text("Education Path: ${career.educationPath}"),
